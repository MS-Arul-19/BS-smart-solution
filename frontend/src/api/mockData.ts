...
export const MOCK_SERVICES: Service[] = [
  ...
  { id: 's-11', slug: 'welding', name: 'Welding', category: { name: 'Construction & Interior', slug: 'construction-interior', kind: 'BUSINESS' }, shortDescription: 'On-site arc, MIG & TIG welding repair services.', description: 'Skilled welders for emergency gate repair, steel pipe welding, and metal frame joining.', priceLabel: 'ON_INSPECTION', coverageArea: 'Doorstep On-Site Welders', image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 's-19', slug: 'commercial-electrical', name: 'Commercial Electrical', category: { name: 'Electrical', slug: 'electrical-services', kind: 'BUSINESS' }, shortDescription: 'Factory & office 3-phase electrical panel wiring & transformer maintenance.', description: 'Industrial electrical contracting, busbar trunking, and 3-phase load balance wiring.', priceLabel: 'ON_INSPECTION', coverageArea: 'Commercial & Factory Plants', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 's-27', slug: 'refrigerator-repair', name: 'Refrigerator Repair', category: { name: 'AC & Appliances', slug: 'ac-appliances', kind: 'BUSINESS' }, shortDescription: 'Single & double door fridge cooling fix, thermostat & gas charging.', description: 'Expert repair of non-cooling fridges, compressor start relay replacement, and ice defrosting issues.', priceLabel: 'ON_INSPECTION', coverageArea: 'Doorstep Appliance Repair', image: 'https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 's-28', slug: 'washing-machine-repair', name: 'Washing Machine Repair', category: { name: 'AC & Appliances', slug: 'ac-appliances', kind: 'BUSINESS' }, shortDescription: 'Front load & top load washing machine drum repair & motor servicing.', description: 'Fixing water drain errors, noisy drum spin bearings, and electronic PCB control cards.', priceLabel: 'ON_INSPECTION', coverageArea: 'Multi-Brand Repair Technicians', image: 'https://images.unsplash.com/photo-1610557892470-55d9e80c0bce?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 's-29', slug: 'microwave-repair', name: 'Microwave Repair', category: { name: 'AC & Appliances', slug: 'ac-appliances', kind: 'BUSINESS' }, shortDescription: 'Microwave oven heating repair, magnetron & touch panel fixing.', description: 'Quick doorstep fix for non-heating convection microwaves and sparking glass turntables.', priceLabel: 'ON_INSPECTION', coverageArea: 'Citywide Doorstep Service', image: 'https://images.unsplash.com/photo-1585659722983-3a675dabf23d?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 's-35', slug: 'pest-control', name: 'Pest Control', category: { name: 'Home Services', slug: 'home-services', kind: 'BUSINESS' }, shortDescription: 'Cockroach gel treatment, termite eradication & bed bug treatment.', description: 'Odorless herbal gel pest control protecting against cockroaches, ants, termites, and mosquitoes.', priceLabel: 'ON_INSPECTION', coverageArea: 'Hygienic Herbal Pest Control', image: 'https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&w=800&q=80', featured: true },
  ...
  { id: 's-39', slug: 'tree-cutting', name: 'Tree Cutting', category: { name: 'Outdoor Services', slug: 'outdoor-services', kind: 'BUSINESS' }, shortDescription: 'Overgrown tree branch trimming & safe tree removal.', description: 'Professional tree cutters equipped with chainsaws and safety ropes for dangerous branch trimming.', priceLabel: 'ON_INSPECTION', coverageArea: 'Safe City Tree Pruning', image: 'https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 's-47', slug: 'industrial-cleaning', name: 'Industrial Cleaning', category: { name: 'Industrial & Factory Services', slug: 'industrial-factory-services', kind: 'BUSINESS' }, shortDescription: 'Factory floor degreasing, tank descaling & machine cleaning.', description: 'Heavy duty pressure washing and chemical cleaning for manufacturing plants.', priceLabel: 'ON_INSPECTION', coverageArea: 'Industrial Units', image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 's-74', slug: 'towing', name: 'Towing', category: { name: 'Automobile Services', slug: 'automobile-services', kind: 'BUSINESS' }, shortDescription: '24/7 flatbed breakdown car towing assistance.', description: 'Emergency roadside flatbed tow truck service for accidents and breakdown vehicles.', priceLabel: 'ON_INSPECTION', coverageArea: '24/7 Highways & City Towing', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80', featured: true },
  ...
  { id: 's-78', slug: 'accounting', name: 'Accounting', category: { name: 'Business Services', slug: 'business-services', kind: 'BUSINESS' }, shortDescription: 'Tally & Zoho Books monthly bookkeeping & financial statements.', description: 'Outsourced accounting services, profit & loss balance sheet generation, and voucher entry.', priceLabel: 'ON_INSPECTION', coverageArea: 'Outsourced Bookkeepers', image: 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=800&q=80', featured: false },
...
export const MOCK_SOCIAL_SERVICES: Service[] = [
  ...
  // --- 3. Education Support ---
  { id: 'soc-10', slug: 'donate-books', name: 'Donate Books', category: { name: 'Education Support', slug: 'education-support', kind: 'SOCIAL' }, shortDescription: 'Donate story books, school textbooks & competitive exam guides.', description: 'Setting up mini libraries in rural schools with donated books.', priceLabel: 'ON_INSPECTION', coverageArea: 'Rural School Libraries', image: 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?auto=format&fit=crop&w=800&q=80', featured: true },
  { id: 'soc-11', slug: 'donate-school-bags', name: 'Donate School Bags', category: { name: 'Education Support', slug: 'education-support', kind: 'SOCIAL' }, shortDescription: 'Donate durable school backpacks for needy kids.', description: 'Gifting water-resistant sturdy school bags to children at the start of academic terms.', priceLabel: 'ON_INSPECTION', coverageArea: 'Student Bag Drive', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-12', slug: 'donate-stationery', name: 'Donate Stationery', category: { name: 'Education Support', slug: 'education-support', kind: 'SOCIAL' }, shortDescription: 'Donate notebooks, geometry boxes, pens & pencils.', description: 'Distributing annual stationery kits to government school students.', priceLabel: 'ON_INSPECTION', coverageArea: 'Stationery Kits Distribution', image: 'https://images.unsplash.com/photo-1583485088034-697b5bc54ccd?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  // --- 4. Children Support ---
  { id: 'soc-14', slug: 'donate-toys', name: 'Donate Toys', category: { name: 'Children Support', slug: 'children-support', kind: 'SOCIAL' }, shortDescription: 'Donate soft toys, board games & outdoor sports items.', description: 'Bringing smiles to orphan kids by gifting working toys and sports gear.', priceLabel: 'ON_INSPECTION', coverageArea: 'Orphanage Play Units', image: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-15', slug: 'baby-care-items', name: 'Baby Care Items', category: { name: 'Children Support', slug: 'children-support', kind: 'SOCIAL' }, shortDescription: 'Donate baby food, diapers, clothing & cradles.', description: 'Essential infant care kits for destitute single mothers and infant shelters.', priceLabel: 'ON_INSPECTION', coverageArea: 'Infant Shelter Kits', image: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 'soc-17', slug: 'nutrition-kits', name: 'Nutrition Kits', category: { name: 'Children Support', slug: 'children-support', kind: 'SOCIAL' }, shortDescription: 'Health drink mixes, dates & protein biscuits for kids.', description: 'Combating childhood malnutrition with monthly health supplement kits.', priceLabel: 'ON_INSPECTION', coverageArea: 'Rural Child Health Drive', image: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&w=800&q=80', featured: true },

  // --- 5. Household Essentials ---
  { id: 'soc-18', slug: 'furniture-donation', name: 'Furniture Donation', category: { name: 'Household Essentials', slug: 'household-essentials', kind: 'SOCIAL' }, shortDescription: 'Donate old cots, study tables, chairs & almirahs.', description: 'Furnishing old-age homes and orphanages with donated usable furniture.', priceLabel: 'ON_INSPECTION', coverageArea: 'Furniture Pickup & Setup', image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-19', slug: 'mattress-blanket-donation', name: 'Mattress & Blanket Donation', category: { name: 'Household Essentials', slug: 'household-essentials', kind: 'SOCIAL' }, shortDescription: 'Donate bedsheets, pillows, mattresses & warm blankets.', description: 'Comfortable sleeping bedding support for senior citizen shelters.', priceLabel: 'ON_INSPECTION', coverageArea: 'Shelter Bedding Support', image: 'https://images.unsplash.com/photo-1584100936595-c0654b55a2e6?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 'soc-21', slug: 'home-appliances-donation', name: 'Home Appliances', category: { name: 'Household Essentials', slug: 'household-essentials', kind: 'SOCIAL' }, shortDescription: 'Donate working fans, water purifiers & washing machines.', description: 'Installing donated home appliances at community welfare centers.', priceLabel: 'ON_INSPECTION', coverageArea: 'Appliance Donation Drive', image: 'https://images.unsplash.com/photo-1618944847828-82e943c3beb9?auto=format&fit=crop&w=800&q=80', featured: true },

  // --- 6. Digital Donation ---
  { id: 'soc-22', slug: 'old-mobile-phones', name: 'Old Mobile Phones', category: { name: 'Digital Donation', slug: 'digital-donation', kind: 'SOCIAL' }, shortDescription: 'Donate working smartphones for poor students.', description: 'Refurbishing old Android phones for poor kids to access online classes.', priceLabel: 'ON_INSPECTION', coverageArea: 'Smart Phone Donation', image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=800&q=80', featured: true },
  { id: 'soc-23', slug: 'laptops', name: 'Laptops', category: { name: 'Digital Donation', slug: 'digital-donation', kind: 'SOCIAL' }, shortDescription: 'Donate old laptops for student coding & computer education.', description: 'Gifting tested laptops to college students for technical skill building.', priceLabel: 'ON_INSPECTION', coverageArea: 'Laptop Refurbish Center', image: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=800&q=80', featured: true },
  { id: 'soc-24', slug: 'computers', name: 'Computers', category: { name: 'Digital Donation', slug: 'digital-donation', kind: 'SOCIAL' }, shortDescription: 'Donate desktop PCs & monitors for village computer labs.', description: 'Setting up full desktop computer labs in government rural schools.', priceLabel: 'ON_INSPECTION', coverageArea: 'School Computer Lab Drive', image: 'https://images.unsplash.com/photo-1587831990711-23ca6441447b?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-25', slug: 'tablets', name: 'Tablets', category: { name: 'Digital Donation', slug: 'digital-donation', kind: 'SOCIAL' }, shortDescription: 'Donate Android/iPad tablets for digital learning.', description: 'Empowering children with e-learning tablets pre-loaded with digital books.', priceLabel: 'ON_INSPECTION', coverageArea: 'Tablet Learning Program', image: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-26', slug: 'printers', name: 'Printers', category: { name: 'Digital Donation', slug: 'digital-donation', kind: 'SOCIAL' }, shortDescription: 'Donate laserjet printers for NGO offices & schools.', description: 'Providing functional printers for printing study worksheets and certificates.', priceLabel: 'ON_INSPECTION', coverageArea: 'Printer Donation Drive', image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 'soc-28', slug: 'medicine-donation', name: 'Medicine Donation', category: { name: 'Health & Medical', slug: 'health-medical', kind: 'SOCIAL' }, shortDescription: 'Donate unexpired essential medicines.', description: 'Collecting unused sealed medicines and distributing them under pharmacist guidance.', priceLabel: 'ON_INSPECTION', coverageArea: 'Free Medical Pharmacy', image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-29', slug: 'medical-equipment-donation', name: 'Medical Equipment Donation', category: { name: 'Health & Medical', slug: 'health-medical', kind: 'SOCIAL' }, shortDescription: 'Donate oxygen concentrators, walkers & hospital beds.', description: 'Loaning free home medical equipment to needy bedridden patients.', priceLabel: 'ON_INSPECTION', coverageArea: 'Free Equipment Loan Bank', image: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-30', slug: 'wheelchair-donation', name: 'Wheelchair Donation', category: { name: 'Health & Medical', slug: 'health-medical', kind: 'SOCIAL' }, shortDescription: 'Gift folding wheelchairs to disabled & elderly individuals.', description: 'Restoring mobility by gifting sturdy steel folding wheelchairs to polio & accident victims.', priceLabel: 'ON_INSPECTION', coverageArea: 'Wheelchair Gift Drive', image: 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=800&q=80', featured: true },
  ...
  { id: 'soc-32', slug: 'beach-cleaning', name: 'Beach Cleaning', category: { name: 'Environment', slug: 'environment-drives', kind: 'SOCIAL' }, shortDescription: 'Weekend coastal beach waste & plastic cleanup.', description: 'Volunteer drive clearing plastic bottles and trash from coastal shorelines.', priceLabel: 'ON_INSPECTION', coverageArea: 'Coastal Shore Cleanup', image: 'https://images.unsplash.com/photo-1618477388954-7852f32655ec?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-33', slug: 'plastic-recycling', name: 'Plastic Recycling', category: { name: 'Environment', slug: 'environment-drives', kind: 'SOCIAL' }, shortDescription: 'Collection drive for recyclable waste plastic.', description: 'Redirecting single-use plastics from landfills to certified recycling shredders.', priceLabel: 'ON_INSPECTION', coverageArea: 'Plastic Waste Collection', image: 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&w=800&q=80', featured: false },
  { id: 'soc-34', slug: 'e-waste-collection', name: 'E-Waste Collection', category: { name: 'Environment', slug: 'environment-drives', kind: 'SOCIAL' }, shortDescription: 'Safe disposal & recycling of electronic scrap.', description: 'Collecting electronic junk, circuit boards, batteries, and old wiring for eco disposal.', priceLabel: 'ON_INSPECTION', coverageArea: 'Certified E-Waste Recycling', image: 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?auto=format&fit=crop&w=800&q=80', featured: false },
  ...
  { id: 'soc-40', slug: 'support-old-age-homes', name: 'Support Old-Age Homes', category: { name: 'Community Support', slug: 'community-support', kind: 'SOCIAL' }, shortDescription: 'Sponsor medicines, adult diapers & meals for senior citizens.', description: 'Care and healthcare support for senior citizens living in old-age homes.', priceLabel: 'ON_INSPECTION', coverageArea: 'Senior Citizen Homes', image: 'https://images.unsplash.com/photo-1581579438747-104c53d0e956?auto=format&fit=crop&w=800&q=80', featured: true },
